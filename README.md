...
Please see the ```r R```-functions for complete documentation of the settings/options and get in contact with me at ioannis.kalogridis@glasgow.ac.uk for any issues/questions.
